function [imxi,imyi,heads,whsn,err,nearest,dist,snx,sny,snth,errsel,p,pxsnx,pxsny,pxsnth,isnew]=g_imdb_route_geterrs(shortwhd,routenum,res,zht,useinfomax,forcegen)
if nargin < 5
    forcegen = false;
end
