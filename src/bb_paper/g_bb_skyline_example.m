...
g_bb_ridf(imdb_plants,1,zht,zht,false,improc,coords,shiftridfs,dosave,true,figtype);
g_bb_ridf(['skyline_' imdb_plants],1,zht,zht,false,improc,coords,shiftridfs,dosave,true,figtype);
g_bb_ridf(['skylinebg_' imdb_plants],1,zht,zht,false,improc,coords,shiftridfs,dosave,true,figtype);
