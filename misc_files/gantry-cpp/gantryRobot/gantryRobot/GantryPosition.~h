 ...
 */
class Position : public Serialisable {
public:
  /**
  ...
  /**
   * Constructs a Position instance given the position in millimeters.
   * Constructs a Position instance given the position in millimeters. The
   ...
   */
  static double distanceBetweenPoints( const Position&, const Position& );

  /**
   * A static method to calculate an intermediate position the fraction
   * of the distance from one point to another.
   */
  static void calculateIntermediatePosition( Position&       buffer,
					     double          fraction,
					     const Position&,
					     const Position& );
  /**
