...
public:
  ...
  void                      getPosition( GantryPosition& positionBuffer ) const;
  const GantryPosition&           getPosition()                           const;
  ...
  void moveToPosition(           const GantryPosition&    position,
		                 bool               waitFlag         );
