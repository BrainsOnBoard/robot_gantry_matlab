...
public:
  ...
  SlewRawData( bool twoDimensionsFlag = false) : m_TwoDimensionsFlag( twoDimensionsFlag ) { }
  SlewRawData( const char *filename, bool twoDimensionsFlag = false );
  virtual ~SlewRawData() { }
