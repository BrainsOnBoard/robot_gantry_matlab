...
public:
   ...
   */
  const char *skipToken( const char *str, const char *token ) const;
   ...
   */
  const char *parseUnsignedInteger( const char   *str, 
   ...
   * @returns   A pointer to the area immediately after the parsed data.
   */
  const char *parseInteger( const char   *str,
                            int          *intBuf ) const;
   ...
   * @returns   A pointer to the area immediately after the parsed data.
   */
  const char *parseDouble( const char *str, 
